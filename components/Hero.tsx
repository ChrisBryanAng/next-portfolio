...
const Hero = () => {
  return (
    <div className="relative w-full flex flex-col space-y-10 mt-16 md:mt-6">
      ...
      <div className="flex flex-col gap-10 md:absolute md:bottom-0 md:bg-white md:w-[75%]">
        <div className="flex">
          <p className="font-Ibarra font-bold text-[50px] md:text-[40px] md:pt-14 text-balance tracking-[1px] leading-tight">
